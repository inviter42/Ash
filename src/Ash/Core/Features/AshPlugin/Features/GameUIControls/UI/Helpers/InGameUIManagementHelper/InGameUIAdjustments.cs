...
namespace Ash.Core.Features.AshPlugin.Features.GameUIControls.UI.Helpers.InGameUIManagementHelper
{
    internal static class InGameUIAdjustments
    {
        private static readonly AshLogger Logger = new AshLogger(LoggingSettings.LoggingModules.GameUIControls);
        ...
        internal static void AdjustGages(Canvas canvas) {
            ...
            if (maleGage == null || femaleGage == null) {
                Logger.LogWarning("One or more gage references are null");
                return;
            }
        ...
        internal static void AdjustXtcLocks(Canvas canvas) {
            ...
            if (maleXtcLock == null || femaleXtcLock == null) {
                Logger.LogWarning("One or more XTCLock references are null");
                return;
            }
        ...
        internal static void AdjustPad(Canvas canvas) {
            ...
            if (pad == null) {
                Logger.LogWarning("Pad reference is null");
                return;
            }
        ...
        internal static void AdjustActButtons(Canvas canvas) {
            ...
            if (actButtons == null) {
                Logger.LogWarning("ActButtons reference is null");
                return;
            }
