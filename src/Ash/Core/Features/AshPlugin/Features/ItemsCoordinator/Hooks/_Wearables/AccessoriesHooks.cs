...
namespace Ash.Core.Features.AshPlugin.Features.ItemsCoordinator.Hooks._Wearables
{
    internal class AccessoriesHooks
    {
        ...
        internal static void ChangeShowPostfix(Accessories __instance, int slotNo, bool show) {
            ...
            if (f == null) {
                if (__instance.wearsRoot.transform.parent.gameObject.GetComponent<Male>() == null)
                    AshLogger.LogWarning(
                        LoggingSettings.LoggingModules.WearablesHooks,
        ...
        // ReSharper disable once InconsistentNaming
        internal static void ChangeShowPostfix(Accessories __instance, bool show) {
